...
var middlewareSecret = "e0b4ddd6-78df-41ca-8616-d4c545767ce8";
//#endregion
...
var _page5 = () => import("./chunks/recent-work_Do6lPR86.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "e0b4ddd6-78df-41ca-8616-d4c545767ce8") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
